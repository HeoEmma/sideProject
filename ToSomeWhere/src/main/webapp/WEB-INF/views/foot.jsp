...
<footer class="bg-dark text-center text-white"  style="background-color: rgba(0, 0, 0, 0.2);">
  ...
  <div class=" p-4"  style="background-color: rgba(0, 0, 0, 0.2);">
    ...
    <section class="mb-4">
      <p>
        ...
        <br/>
        With it, the seller users can show their products.
        <br/>
        With it, the customer users can book places.
        <br/>
      </p>
    </section>
    <!-- Section: Text -->
    ...
    <section class="mb-4 container">
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-md-6 mb-3 mb-md-0">
          ...
          <ul class="list-unstyled mb-0">
            <li>
              <a href="#!" class="text-white">Bootstrap v5</a>
            </li>
            <li>
              <a href="#!" class="text-white">Link 2</a>
            </li>
  ...
  <!-- Copyright -->
  <div class="text-center p-3 text-center text-muted"  style="background-color: rgba(0, 0, 0, 0.2);">
